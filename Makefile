...
CFLAGS := $(INC) -D_MIPS_SZLONG=32 -D_LANGUAGE_C -nostdinc -fno-builtin -fno-PIC -mno-abicalls -mcpu=4300 -G 0 -mgp32 -Wall -Wa,-Iinclude
ASFLAGS := $(INC) -D_MIPS_SZLONG=32 -D_LANGUAGE_ASSEMBLY -nostdinc -fno-PIC -mno-abicalls -mcpu=4300 -G 0
OPTFLAGS := -Os -g3
MIPS_VERSION := -mips3
